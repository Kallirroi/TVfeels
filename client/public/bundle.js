...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Root = __webpack_require__(/*! ./Root.jsx */ 160);
	
	var _Root2 = _interopRequireDefault(_Root);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var main = (0, _reactDom.render)(_react2.default.createElement(_Root2.default, null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Cell = __webpack_require__(/*! ./Cell.jsx */ 161);
	
	var _Cell2 = _interopRequireDefault(_Cell);
	
	var _TitleRow = __webpack_require__(/*! ./TitleRow.jsx */ 162);
	
	var _TitleRow2 = _interopRequireDefault(_TitleRow);
	
	var _DateTitleBox = __webpack_require__(/*! ./DateTitleBox.jsx */ 164);
	
	var _DateTitleBox2 = _interopRequireDefault(_DateTitleBox);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var clone = function clone(toClone) {
	...
	var Root = _react2.default.createClass({
	    ...
	    clickCell: function clickCell(key) {
	    ...
	    render: function render() {
	        ...
	        for (var key in data) {
	            if (data.hasOwnProperty(key)) {
	                ...
	                cells.push(_react2.default.createElement(_Cell2.default, { key: key,
	                    enabled: enabled,
	                    name: key,
	                    isPlaying: isPlaying,
	                    item: item,
	        ...
	        return _react2.default.createElement(
	            'div',
	            { style: rootStyle },
	            _react2.default.createElement(_DateTitleBox2.default, { batchIndex: trendIndex, setIndex: this.setIndex }),
	            _react2.default.createElement(_TitleRow2.default, null),
	            _react2.default.createElement(
	                'div',
	                { style: divStyle },
	                cells
...
/***/ function(module, exports, __webpack_require__) {
	...
	var THUMBOJURE_HOST = "http://thumbojure.um-dokku.media.mit.edu";
	//const THUMBOJURE_HOST = "http://localhost:3000";
	
	/**
	 * Created by weller on 2/4/16.
	 */
	var getThumbnailUrl = function getThumbnailUrl(url, start, duration) {
	    return THUMBOJURE_HOST + "/thumb?url=" + encodeURIComponent(url) + "&start=" + start + "&duration=" + duration;
	};
	...
	var Cell = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var videoElement = _react2.default.createElement("div", null);
	        var startAt = 0;
	        var thumbSrc = "";
	        ...
	        if (scene) {
	            ...
	            if (this.props.isPlaying) {
	                ...
	                videoElement = _react2.default.createElement("video", { style: videoStyle, src: videoUrl, autoPlay: true, loop: true, onPlaying: this.onPlaying,
	        ...
	        return _react2.default.createElement(
	            "div",
	            { style: divStyle, onClick: this.click },
	            _react2.default.createElement("img", { style: imgStyle, src: thumbSrc }),
	            _react2.default.createElement("div", { style: imgShader }),
	            _react2.default.createElement(
	                "h1",
	                { style: h1Style },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TitleCell = __webpack_require__(/*! ./TitleCell.jsx */ 163);
	
	var _TitleCell2 = _interopRequireDefault(_TitleCell);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var TitleRow = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        titles.forEach(function (val, key) {
	            titleCells.push(_react2.default.createElement(_TitleCell2.default, { key: key, index: key, title: val }));
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleCell = _react2.default.createClass({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swipejs = __webpack_require__(/*! swipejs */ 165);
	...
	var DateTitle = function DateTitle(props) {
	    return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	...
	var DateTitleBox = function (_React$Component) {
	    _inherits(DateTitleBox, _React$Component);
	
	    function DateTitleBox(props) {
	        _classCallCheck(this, DateTitleBox);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(DateTitleBox).call(this, props));
	    }
	
	    _createClass(DateTitleBox, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            var that = this;
	            this.swipe = (0, _swipejs2.default)(_reactDom2.default.findDOMNode(this), {
	                startSlide: 0,
	                draggable: true,
	                autoRestart: false,
	                continuous: true,
	        ...
	        value: function render() {
	            ...
	            for (var i = 6; i >= 0; i--) {
	                ...
	                dateTitles.push(_react2.default.createElement(DateTitle, { title: d, key: i, index: i }));
	            }
	
	            return _react2.default.createElement(
	                'div',
	                { style: divStyle, id: 'slider', className: 'swipe' },
	                _react2.default.createElement(
	                    'div',
	                ...
	                _react2.default.createElement(
	                    'h1',
	                    { style: rightArrowStyle, onClick: function onClick(e) {
	                            _this2.props.setIndex(_this2.props.batchIndex - 1);
	                        } },
	                    ' > '
	                ),
	                _react2.default.createElement(
	                    'h1',
	                    { style: leftArrowStyle, onClick: function onClick(e) {
	                            _this2.props.setIndex(_this2.props.batchIndex + 1);
	                        } },
	                    ' ',
	                    "<",
